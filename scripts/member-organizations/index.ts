...
import type { Groups, Result, Group, Participations, Participant, Organization, OrganizationData } from './types.ts';
...
async function fetchMemberOrganizations() {
  ...
  try {
    ...
    const outputPath = resolve(__dirname, '../../website/lib/generated/memberOrganizationsOutput.json');
    mkdirSync(dirname(outputPath), { recursive: true });
    writeFileSync(outputPath, JSON.stringify(orderedResult, null, 2));
    console.log('website/lib/generated/memberOrganizationsOutput.json successfully generated');
  } catch (error) {
